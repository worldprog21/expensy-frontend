...
const ErrorComponent = () => {
    return (
        <div className="bg-red-100 my-5 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
            <div className="flex">
                ...
                <div>
                    ...
                    <p className="text-sm">An error occured, please contact the system administrator</p>
                </div>
            </div>
        </div>
    )
