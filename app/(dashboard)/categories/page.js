...
const PaymentCategories = () => {
    ...
    const fetchData = async (page, filterField, filterValue) => {
        ...
        url = process.env.NEXT_PUBLIC_BASE_URL + `/categories?pagination[page]=${page}&pagination[pageSize]=10&sort[0]=id%3Adesc` + filterQuery + userQuery
    ...
    const { isLoading, error, data, isFetching } =
        useQuery({
            queryKey: ["categories", pagination.page, filterField, filterValue, user],
        ...
        <div className="h-full -mt-6 p-10 md:p-5">
            <div className="rounded bg-gray-50 h-full border border-dashed p-5">
                <div className="flex items-center justify-between">
                    <h1 className="text-lg font-medium">Payment Categories</h1>
